...
SECUENCIAL="mpirun -np 4 ./bruteforce4"
PARALELO="mpirun -np 4 ./bruteforceVar22"

# Claves para prueba (puedes usar operaciones aquí)
KEYS=(1234567 7654321 12345678 876543210 1234567890 9876543210 12345678901 98765432109 "(2^56) / 2) + 1" "((2^56) / 2) + ((2^56) / 8)")

# Archivo de resultados
RESULTADOS_FILE="resultadosP.txt"
